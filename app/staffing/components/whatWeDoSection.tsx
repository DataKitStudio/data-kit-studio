...
export default function WhatWeDoSection() {
    return (
        <div className="flex flex-col pb-20 pt-20 rounded-4xl -mt-10 bg-light items-center w-full ">
            <div className="flex w-[90%] lg:w-[66%] flex-col gap-10 rounded-2xl shadow-md shadow-fuchsia-300 p-10 border border-primary/40 bg-light">
                ...
                <div className="flex flex-col-reverse lg:flex-col items-center justify-center xl:flex-row gap-5">
